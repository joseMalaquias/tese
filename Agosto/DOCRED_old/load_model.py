...
class myLukeSelfAttention(nn.Module):
    ...
    def forward(
        ...
        del context_layer, new_context_layer_shape, attention_probs, value_layer, key_layer
        del diagonal_mask, float_mask, remove_from_windowed_attention_mask, e2e_key_layer, w2e_key_layer, e2w_key_layer, w2w_key_layer
        del e2e_query_layer, e2w_query_layer, w2e_query_layer, w2w_query_layer, concat_hidden_states, word_hidden_states, entity_hidden_states
        return outputs
...
model_path = f'{training_args.output_dir}/LongLuke_DOCRED_new_attention'
model_path_finetuned = "/mnt/shared/home/jose.luis.malaquias.ext/Agosto/DOCRED/model_finetuned_3epocs_new_version"
...
model = ModifiedLuke.from_pretrained(model_path_finetuned) # para fazer avaliacao
#model = ModifiedLuke.from_pretrained(model_path) # para fazer treino
