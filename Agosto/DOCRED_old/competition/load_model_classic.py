...
def create_new_model(save_model_to, attention_window, max_pos):
    model = LukeForEntityPairClassification.from_pretrained("studio-ousia/luke-large")  #original está na pasta atras no train_docred.py
...
model_path = "/mnt/shared/home/jose.luis.malaquias.ext/Agosto/DOCRED/tmp/LongLuke_DOCRED_new_attention"
model_path_finetuned = "/Users/jose.luis.malaquias.ext/Documents/GitTese/luke_87050/Agosto_DOCRED/DOCRED_finetuned"
model_path_competition = "/mnt/shared/home/jose.luis.malaquias.ext/Agosto/DOCRED/model_finetuned_3epocs_new_version"
