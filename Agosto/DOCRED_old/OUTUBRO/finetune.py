...
logging.info(f"The number of train examples is {len(batch_examples)}")
...
training_args = TrainingArguments(
    ...
    output_dir = "train_DOCRED_5epochs_extended",
    num_train_epochs = 2,
    report_to = "none",
...
print_gpu_utilization()
trainer.train("/mnt/shared/home/jose.luis.malaquias.ext/Agosto/DOCRED/DOCRED_OUTUBRO/train_DOCRED_5epochs_extended/checkpoint-14000")
logging.info("Save finetuned model")
trainer.save_model("model_finetuned_5epocs")
